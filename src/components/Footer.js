                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 text-center ">
                        ...
                        <ul class="ftco-footer-social p-0">
                            <li class="ftco-animate"><a target="blank" href="#" data-toggle="tooltip" data-placement="top" title="Github"><i class="bi bi-github"></i></a></li>
                            <li class="ftco-animate"><a target="blank" href="#" data-toggle="tooltip" data-placement="top" title="Instagram"><i class="bi bi-instagram"></i></a></li>
